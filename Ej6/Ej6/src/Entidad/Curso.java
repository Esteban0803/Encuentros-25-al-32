...
public class Curso {
    ...
    public Curso(String nombreCurso, int horasPorDias, int diasPorSemana, String turno, float precioPorHora) {
    ...
    public void setHorasPorDias(int horasPorDias) {
        this.horasPorDias = horasPorDias;
    }
